...
export default function ThirdSection() {
  return (
    <section className="h-auto md:h-screen w-full">
      <div className="h-full w-full bg-[#060707] px-4 py-6 text-white sm:px-6 sm:py-8 md:px-10 md:py-10">
        <div className="flex h-full flex-col gap-8 md:gap-10">
          ...
          <div className="grid flex-1 gap-7 sm:grid-cols-2 xl:grid-cols-4 mt-10">
            <article className="relative flex min-h-[250px] flex-col rounded-[18px] bg-[#34a3dc] p-5">
              ...
              <h3 className="k-card-title mt-auto">
            ...
            <article className="relative flex min-h-[250px] flex-col rounded-[18px] bg-[#e8e8e8] p-5 text-[#1d1d1d]">
              <div className="text-4xl leading-none">
