...
const InvertedBorderCard = ({
  ...
  return (
    <div className="relative flex min-h-[250px] max-w-[400px] md:max-h-[300px] flex-col justify-end rounded-[18px] bg-white hover:scale-105 duration-300 transition-all p-5overflow-hidden p-6 text-white first:bg-[#34a3dc]">
      {/* Top right inverted corner */}
      <div className="absolute right-0 top-0 h-16 w-16 bg-black rounded-bl-[30px]  shadow-md not-first:bg-white">
        <div
      ...
      {/* Content */}
      <div className="relative bottom-0 z-10 flex flex-col gap-5 h-full">
        <div className="">
